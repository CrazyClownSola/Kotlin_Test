...
package com.sola.github.java.widget;
...
class TableLayoutBinder {
    ...
    TableLayoutBinder(Context context) {
        this(context, R.layout.table_media_info);
    }

    private TableLayoutBinder(Context context, int layoutResourceId) {
        mContext = context;
    ...
    TableLayoutBinder(Context context, TableLayout tableLayout) {
        mContext = context;
        mTableView = tableLayout;
        mTableLayout = tableLayout;
    }

    private View appendRow1(String name, String value) {
    ...
    void setValueText(View rowView, String value) {
        ViewHolder viewHolder = obtainViewHolder(rowView);
        viewHolder.setValue(value);
    }
    ...
    AlertDialog.Builder buildAlertDialogBuilder() {
